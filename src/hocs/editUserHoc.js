...
import ModalYesNoPortal from "../modals/ModalYesNoPortal";
	...
	const WrappedByEditUserHoc = () => {
		...
		return (
			<>
				...
				>
					{
						otherModalConfig ? <ModalYesNoPortal num={true} {...otherModalConfig} /> : null
					}
				</Component>
				{
					modalConfig ? <ModalYesNoPortal {...modalConfig} /> : null
				}
			</>
		);
	};
